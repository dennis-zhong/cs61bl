...
public class OuterBanksTest {
    ...
    public void Test() {
        ...
        OuterBanks.Graph g2 = new OuterBanks.Graph(1);
        assertTrue(OuterBanks.getMinLocations(g2)==1);

        OuterBanks.Graph g3 = new OuterBanks.Graph(2);
        OuterBanks.getMinLocations(g3);
        assertTrue(OuterBanks.getMinLocations(g3)==2);
        for(int i = 0; i<10; i++) {
            OuterBanks.Graph g4 = new OuterBanks.Graph(i);
    ...
    @Test
    public void Test2() {
        OuterBanks.Graph g = new OuterBanks.Graph(7);
        g.addEdge(1, 2);
        g.addEdge(3, 4);
        g.addEdge(4, 5);
        g.addEdge(5, 6);
        ...
        OuterBanks.Graph g2 = new OuterBanks.Graph(7);
